        ...
        <div className="relative flex items-center">
          ...
          {communicationMode === 'AUDIO_ONLY' ? (
            <div className="bg-amber-950/10 border border-dashed border-amber-500/30 rounded-xl p-4 w-full text-center text-amber-500 font-mono text-xs">
              ...
              <div className="flex justify-center items-center gap-1 h-6 mt-3 mb-4">
                {[0, 0.1, 0.2, 0.3, 0.4].map((delay, i) => (
                  <motion.div
                    ...
                    animate={{ height: [4, Math.floor(Math.random() * 20) + 10, 4] }}
              ...
              <button
                onClick={() => setCommunicationMode('TEXT')}
                className="text-[10px] font-bold tracking-widest uppercase border border-red-900/50 hover:bg-red-950/40 text-red-400 hover:text-red-300 transition-colors px-4 py-2 rounded-lg cursor-pointer inline-block z-50 relative pointer-events-auto"
              >
